...
public class RegexUtil {
	...
	public static final String IP_REGEX2 = "[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}";
	...
	public static boolean isMatch(final String regex, final String string) {
		if (StringUtil.isNullOrEmpty(regex) || StringUtil.isNullOrEmpty(string)) {
			return false;
		}
	...
	public static String replaceToRegex(final String string) {
